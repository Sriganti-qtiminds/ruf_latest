const tailwindStyles = {
  ...
  thirdButton:
    "text-gray-600 hover:bg-gray-200 px-4 py-1 text-sm font-semibold rounded-md text-center border border-[#ffc107]",
  card: "bg-gray-200",
  whiteCard: "bg-white",
  ...
  paragraph_less: "text-gray-600 text-[8px] lg:text-[10px] 2xl:text-md",
};
